        ...
        <div className="space-y-4">
          ...
          {shares?.map((share) => (
            <div  key={share.id} className="flex items-center justify-between p-4 border border-[#1d1d1d] rounded-lg">
              <a target='_blank' href={`${typeof window !== 'undefined' ? window.location.origin : process.env.NEXT_PUBLIC_APP_URL || 'https://finaljusticeminds-fyqa.vercel.app'}/share/groups?id=${share?.uuid}&token=${userId}`} className="flex-1 ">
